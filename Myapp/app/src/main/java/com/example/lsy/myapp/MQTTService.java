...
//    private String passWord = "password";
    private static String myTopic = "hello";
...
//        String topic = myTopic;
    ...
    public class MyBinder extends Binder {
        ...
        public void intentPublish(String topic,String msg)
        {
            publish(topic,msg);
        }
        public void intentSubscribe(String topic)
        {
            subscribe(topic);
        }
    }
    ...
    private void init() {
        ...
        clientId = String.valueOf(sp.getInt("userId",0));
