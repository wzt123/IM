...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.BaseAdapter> {
    ...
    private class ChatAViewHolder extends BaseAdapter {
        ...
        void setData(Object object) {
            ...
            //Picasso.with(itemView.getContext()).load(model.getIcon()).placeholder(R.mipmap.ic_launcher_round).into(ic_user);
            ic_user.setImageResource(R.mipmap.ic_launcher_round);
